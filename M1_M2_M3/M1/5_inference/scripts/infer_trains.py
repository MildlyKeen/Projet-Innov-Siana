...
# CONFIG
# -----------------------------
MODEL_PATH = r"models/trains/best.pt"  # ton modèle trains (1 classe)
SOURCE_VIDEO = r"8_inputs/cam1_1.mp4"                         # <-- mets ton chemin vidéo
OUT_VIDEO = r"7_outputs/overlays/trains_track_overlay.mp4"
OUT_JSONL = r"M1_M2_M3/M3/inputs/from_member1/trains_per_frame.jsonl"
