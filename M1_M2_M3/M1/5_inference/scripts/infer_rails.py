...
# CONFIG
# -----------------------------
MODEL_PATH = r"models/rails/best.pt"   # rails onnx
SOURCE_VIDEO = r"8_inputs/cam1_1.mp4"                             # <-- mets ton chemin
OUT_VIDEO = r"7_outputs/overlays/rails_overlay.mp4"
OUT_JSONL = r"M1_M2_M3/M3/inputs/from_member1/rails_per_frame.jsonl"
